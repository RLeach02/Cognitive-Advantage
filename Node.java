...
public class Node {
    ...
    /**
     * Method to return a list of network
    ...
    /**
     * Method to return size of network list
     * @return int of size
     */
    ...
    /**
     * Method to print the network bearer in the network list
     */
    ...
    public void init() {
        ...
        //pingNetwork(networkList.get(1), 5);
        changeMetric("wwan0", 250);
        timer(2);
    ...
    public static void main(String[] args) {
        Node n1 = new Node("Host", "user", "Pass");
        n1.init();
    }
}
